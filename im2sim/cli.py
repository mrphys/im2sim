...
def install_pyg():
    ...
    if pyg_version >= 280:
        print("Detected PyTorch Geometric version >= 2.8.0, installing pyg-lib and torch-scatter...")
        ...
        print("Detected PyTorch Geometric version < 2.8.0, installing torch-scatter, torch-sparse, torch-cluster, and torch-spline-conv...")
        subprocess.check_call([
            sys.executable,
            "-m",
            "pip",
