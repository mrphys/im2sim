...
class GraphConvBlockConfig(Config):
    ...
    Args:
        ...
        norm_cfg (LayerConfig):
            Configuration for the normalization layers.
            Default is `im2sim.layers.DefaultGraphNorm`.
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            cfg = GraphConvBlockConfig(
                        ...
                        dropout_cfg=LayerConfig(name="EdgeDropout", kwargs={"p": 0.1}),
