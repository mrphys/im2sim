...
#         gnn_conv_type="GATConv",
#         gnn_conv_kwargs=None,
#         gnn_activation="relu",
...
#                     projection_channels=projection_channels[i],
...
#             proj_inp = torch.cat(
#                 [
#                     OGProjection(image_dim=x.shape[-1])(
#                         encoder_outputs[id], curr_mesh[:, :3], template.batch
#                     )
#                     for id in ids
#                 ],
#                 dim=-1,
...
#             #                       for id in ids], dim=-1)
#             graph_features, curr_mesh = dec(
#                 graph_features, proj_inp, curr_mesh, template.edge_index
#             )
