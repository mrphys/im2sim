...
_SUBMODULE_NAMES = ["data", "layers", "configs", "ops", "losses", "models", "plot", "_internal"]

_SUBMODULE_DOCSTRINGS = {
    "data": "Data loading and preprocessing utilities.",
    "layers": "Custom layers for building deep learning models.",
    "configs": "Configuration classes for model and training settings.",
    "ops": "Custom operations for deep learning models.",
    "losses": "Custom loss functions for training deep learning models.",
    "models": "Predefined deep learning models for various tasks.",
    "plot": "Utilities for visualizing data and model outputs.",
    "_internal": "Internal utilities and functions for development and testing purposes.",
}
    ...
    def decorator(symbol):
        ...
        for name in names:
            ...
            if name in _API_SYMBOLS:
                raise ValueError(f"Name {name} already used for exported symbol {symbol}")
